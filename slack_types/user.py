...
class UserProfile(BaseModel):
    ...
    image_1024: str | None = Field(description="1024x1024 pixel image URL")
    image_original: str | None = Field(description="Original image URL")
    is_custom_image: bool | None = Field(description="Whether the image is custom")
